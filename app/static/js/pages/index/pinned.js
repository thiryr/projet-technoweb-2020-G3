...
function get_pinned_recipe_element(img_url, recipe_id, recipe_name, author_id, author_nick, author_first, author_last, is_chef, rating, fav_number, is_fav) {
...
function display_pinned_recipe(recipe) {
    var filled_template = get_pinned_recipe_element(recipe.img_url, recipe.recipe_id, recipe.recipe_name, recipe.author_id,
