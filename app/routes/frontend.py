...
def ping():
    ...
    return render_template_string('<h1>Hello {{name}}</h1> <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script><script>$.post("/api/subscription/create", {username:"Bob"})</script>', name=user.username)
